...
protected:
    ...
    static std::map<simtime_t, double> car1Speeds;
    static std::map<simtime_t, double> bus0Speeds;
    static std::map<simtime_t, double> bus1Speeds;
    static std::map<simtime_t, double> bus2Speeds;
    static std::map<simtime_t, double> bus3Speeds;
    static std::map<simtime_t, double> bus4Speeds;
    static std::map<simtime_t, double> bus5Speeds;
    static std::map<simtime_t, double> bus6Speeds;
    static std::map<simtime_t, double> bus7Speeds;
    static std::map<simtime_t, double> bus8Speeds;
};
