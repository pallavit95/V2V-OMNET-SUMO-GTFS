...
const char * CarMessage::getSenderRsuId() const
{
    return this->senderRsuId.c_str();
}

void CarMessage::setSenderRsuId(const char * senderRsuId)
{
    this->senderRsuId = senderRsuId;
}

::omnetpp::simtime_t CarMessage::getSendTime() const
{
    return this->sendTime;
}

void CarMessage::setSendTime(::omnetpp::simtime_t sendTime)
{
    this->sendTime = sendTime;
}

::omnetpp::simtime_t CarMessage::getResponseTime() const
{
    return this->responseTime;
}

void CarMessage::setResponseTime(::omnetpp::simtime_t responseTime)
{
...
int CarMessageDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='s' && strcmp(fieldName, "senderRsuId")==0) return base+4;
    if (fieldName[0]=='s' && strcmp(fieldName, "sendTime")==0) return base+5;
    if (fieldName[0]=='r' && strcmp(fieldName, "responseTime")==0) return base+6;
...
std::string CarMessageDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 4: return oppstring2string(pp->getSenderRsuId());
        case 5: return simtime2string(pp->getSendTime());
        case 6: return simtime2string(pp->getResponseTime());
        default: return "";
    }
}
...
bool CarMessageDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 4: pp->setSenderRsuId((value)); return true;
        case 5: pp->setSendTime(string2simtime(value)); return true;
        case 6: pp->setResponseTime(string2simtime(value)); return true;
