...
protected:
    ...
    virtual void placeService(std::string rsuId, std::string serviceName, std::string serviceData, double startTime, double endTime);
    ...
    virtual void exportInteractionLog();
